...
class TestLifespanEvents:
    ...
    async def test_lifespan_startup_validates_config(self) -> None:
        ...
        with (
            patch("fastapi_template.main.settings") as mock_settings,
            patch("fastapi_template.main.create_db_engine", return_value=mock_engine),
            patch("fastapi_template.main.create_session_maker"),
        ):
