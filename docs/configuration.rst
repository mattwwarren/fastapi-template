...
``fastapi_template/core/config.py`` defines all available options with their
...
.. autoclass:: fastapi_template.core.config.Settings
   :members:
   :undoc-members:
   :show-inheritance:
   ...
   - ``APP_NAME`` - Application name (default: ``fastapi_template``)
...
.. autoclass:: fastapi_template.core.config.ConfigurationError
   :members:
   :show-inheritance:
...
.. code-block:: python
   ...
   from fastapi_template.core.config import settings, ConfigurationError
