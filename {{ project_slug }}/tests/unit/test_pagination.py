...
from {{ project_slug }}.core.pagination import DefaultParams, configure_pagination
...
class TestConfigurePagination:
    ...
    def test_no_op_when_no_custom_class(self) -> None:
        ...
        with patch("{{ project_slug }}.core.pagination.settings") as mock_settings:
    ...
    def test_sets_valid_page_class(self) -> None:
        ...
        with (
            patch("{{ project_slug }}.core.pagination.settings") as mock_settings,
            patch("{{ project_slug }}.core.pagination.importlib") as mock_importlib,
            patch("{{ project_slug }}.core.pagination.set_page") as mock_set_page,
        ):
    ...
    def test_parses_nested_module_path(self) -> None:
        ...
        with (
            patch("{{ project_slug }}.core.pagination.settings") as mock_settings,
            patch("{{ project_slug }}.core.pagination.importlib") as mock_importlib,
            patch("{{ project_slug }}.core.pagination.set_page"),
        ):
