...
from {{ project_slug }}.core.metrics import active_memberships_gauge, memberships_created_total
from {{ project_slug }}.models.membership import Membership, MembershipCreate, MembershipRole, MembershipUpdate
