...
from {{ project_slug }}.core.auth import AuthMiddleware, CurrentUser, _parse_user_headers, get_user_from_headers
...
def mock_http_client_factory() -> Generator[Any]:
    ...
    Usage:
        def test_auth0_success(mock_http_client_factory):
            ...
            with patch("{{ project_slug }}.core.auth.http_client", return_value=mock_client):
                # test code
