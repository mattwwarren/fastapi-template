...
|---------|----------|--------------|-----------------|--------|-------|
| test-instance | `/home/matthew/workspace/meta-work/fastapi-template-test-instance` | 2026-01-07 | HEAD | ✅ Up-to-date | Persistent test instance for template verification |
...
```bash
copier copy /home/matthew/workspace/meta-work/fastapi-template /path/to/new-project \
